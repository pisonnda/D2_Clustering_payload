#!/usr/bin/python3
#2023.04.12: label = ["TIME", "ASN", "SRCIP", "DSTIP", "TTL", "IPID", "SPORT", "DPORT", "SEQ_N", "WINDS", "ISRCIP", "IDSTIP", "VHASH"]
#2023.04.19: Database Server -> MYSQL Database
...
if len(sys.argv) != 5: 
    print("Syntax Error")
    print("Syntax: make_data_dest.py <pcap_file.pcap.zst> AS Database_name Packets")
    sys.exit()

pcap_file = sys.argv[1]
AS = int(sys.argv[2])
table_name = sys.argv[3]
max_packets = sys.argv[4]
dst_dict = {}
...
def main():
    ...
    engine = create_engine('mysql+pymysql://pison:Ramen!yokosuka2023@localhost/as' + str(AS) + '?charset=utf8')
